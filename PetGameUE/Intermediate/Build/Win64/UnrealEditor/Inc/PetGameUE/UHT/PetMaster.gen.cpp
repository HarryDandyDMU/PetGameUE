...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_APetMaster_Statics::NewProp_PFJoyful_MetaData[] = {
		{ "Category", "Mood" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "//variables for stats for all pets\n// NF = NEGATIVE FLOAT (BAD TRAIT)\n// PF = POSITIVE FLOAT (POSITIVE TRAIT)\n" },
#endif
		{ "ModuleRelativePath", "Public/PetMaster.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "variables for stats for all pets\n NF = NEGATIVE FLOAT (BAD TRAIT)\n PF = POSITIVE FLOAT (POSITIVE TRAIT)" },
#endif
	};
#endif
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PetGameUE_Source_PetGameUE_Public_PetMaster_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_APetMaster, APetMaster::StaticClass, TEXT("APetMaster"), &Z_Registration_Info_UClass_APetMaster, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(APetMaster), 2286075323U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PetGameUE_Source_PetGameUE_Public_PetMaster_h_3935450142(TEXT("/Script/PetGameUE"),
