...
// End Cross Module References
	DEFINE_FUNCTION(ACaveMaster::execOnBeginOverlapBoxExit)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->OnBeginOverlapBoxExit(Z_Param_OverlappedComp,Z_Param_OtherActor,Z_Param_OtherComp,Z_Param_OtherBodyIndex,Z_Param_bFromSweep,Z_Param_Out_SweepResult);
		P_NATIVE_END;
	}
	...
	void ACaveMaster::StaticRegisterNativesACaveMaster()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "OnBeginOverlapBoxExit", &ACaveMaster::execOnBeginOverlapBoxExit },
		};
	...
	struct Z_Construct_UFunction_ACaveMaster_OnBeginOverlapBoxExit_Statics
	{
		struct CaveMaster_eventOnBeginOverlapBoxExit_Parms
		{
			UPrimitiveComponent* OverlappedComp;
			AActor* OtherActor;
			UPrimitiveComponent* OtherComp;
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ACaveMaster_OnBeginOverlapBoxExit_Statics::NewProp_OverlappedComp_MetaData[] = {
		{ "EditInline", "true" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_ACaveMaster_OnBeginOverlapBoxExit_Statics::NewProp_OverlappedComp = { "OverlappedComp", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(CaveMaster_eventOnBeginOverlapBoxExit_Parms, OverlappedComp), Z_Construct_UClass_UPrimitiveComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ACaveMaster_OnBeginOverlapBoxExit_Statics::NewProp_OverlappedComp_MetaData), Z_Construct_UFunction_ACaveMaster_OnBeginOverlapBoxExit_Statics::NewProp_OverlappedComp_MetaData) };
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_ACaveMaster_OnBeginOverlapBoxExit_Statics::NewProp_OtherActor = { "OtherActor", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(CaveMaster_eventOnBeginOverlapBoxExit_Parms, OtherActor), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ACaveMaster_OnBeginOverlapBoxExit_Statics::NewProp_OtherComp_MetaData[] = {
		{ "EditInline", "true" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_ACaveMaster_OnBeginOverlapBoxExit_Statics::NewProp_OtherComp = { "OtherComp", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(CaveMaster_eventOnBeginOverlapBoxExit_Parms, OtherComp), Z_Construct_UClass_UPrimitiveComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ACaveMaster_OnBeginOverlapBoxExit_Statics::NewProp_OtherComp_MetaData), Z_Construct_UFunction_ACaveMaster_OnBeginOverlapBoxExit_Statics::NewProp_OtherComp_MetaData) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_ACaveMaster_OnBeginOverlapBoxExit_Statics::NewProp_OtherBodyIndex = { "OtherBodyIndex", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(CaveMaster_eventOnBeginOverlapBoxExit_Parms, OtherBodyIndex), METADATA_PARAMS(0, nullptr) };
	void Z_Construct_UFunction_ACaveMaster_OnBeginOverlapBoxExit_Statics::NewProp_bFromSweep_SetBit(void* Obj)
	{
		((CaveMaster_eventOnBeginOverlapBoxExit_Parms*)Obj)->bFromSweep = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_ACaveMaster_OnBeginOverlapBoxExit_Statics::NewProp_bFromSweep = { "bFromSweep", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(CaveMaster_eventOnBeginOverlapBoxExit_Parms), &Z_Construct_UFunction_ACaveMaster_OnBeginOverlapBoxExit_Statics::NewProp_bFromSweep_SetBit, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ACaveMaster_OnBeginOverlapBoxExit_Statics::NewProp_SweepResult_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_ACaveMaster_OnBeginOverlapBoxExit_Statics::NewProp_SweepResult = { "SweepResult", nullptr, (EPropertyFlags)0x0010008008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(CaveMaster_eventOnBeginOverlapBoxExit_Parms, SweepResult), Z_Construct_UScriptStruct_FHitResult, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ACaveMaster_OnBeginOverlapBoxExit_Statics::NewProp_SweepResult_MetaData), Z_Construct_UFunction_ACaveMaster_OnBeginOverlapBoxExit_Statics::NewProp_SweepResult_MetaData) }; // 1891709922
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ACaveMaster_OnBeginOverlapBoxExit_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ACaveMaster_OnBeginOverlapBoxExit_Statics::NewProp_OverlappedComp,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ACaveMaster_OnBeginOverlapBoxExit_Statics::NewProp_OtherActor,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ACaveMaster_OnBeginOverlapBoxExit_Statics::NewProp_OtherComp,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ACaveMaster_OnBeginOverlapBoxExit_Statics::NewProp_OtherBodyIndex,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ACaveMaster_OnBeginOverlapBoxExit_Statics::NewProp_bFromSweep,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ACaveMaster_OnBeginOverlapBoxExit_Statics::NewProp_SweepResult,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ACaveMaster_OnBeginOverlapBoxExit_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/CaveMaster.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ACaveMaster_OnBeginOverlapBoxExit_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ACaveMaster, nullptr, "OnBeginOverlapBoxExit", nullptr, nullptr, Z_Construct_UFunction_ACaveMaster_OnBeginOverlapBoxExit_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ACaveMaster_OnBeginOverlapBoxExit_Statics::PropPointers), sizeof(Z_Construct_UFunction_ACaveMaster_OnBeginOverlapBoxExit_Statics::CaveMaster_eventOnBeginOverlapBoxExit_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00420401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ACaveMaster_OnBeginOverlapBoxExit_Statics::Function_MetaDataParams), Z_Construct_UFunction_ACaveMaster_OnBeginOverlapBoxExit_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ACaveMaster_OnBeginOverlapBoxExit_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_ACaveMaster_OnBeginOverlapBoxExit_Statics::CaveMaster_eventOnBeginOverlapBoxExit_Parms) < MAX_uint16);
	UFunction* Z_Construct_UFunction_ACaveMaster_OnBeginOverlapBoxExit()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_ACaveMaster_OnBeginOverlapBoxExit_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ACaveMaster_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_ACaveMaster_OnBeginOverlapBoxExit, "OnBeginOverlapBoxExit" }, // 1009335539
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PetGameUE_Source_PetGameUE_Public_CaveMaster_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ACaveMaster, ACaveMaster::StaticClass, TEXT("ACaveMaster"), &Z_Registration_Info_UClass_ACaveMaster, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ACaveMaster), 3947833641U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PetGameUE_Source_PetGameUE_Public_CaveMaster_h_4183520865(TEXT("/Script/PetGameUE"),
